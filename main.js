...
function myKeyDown(e)
{
	...
	function up()
	{
		...
		ballY = ballY - block_image_height;
			...
			console.log("Quando a tecla direcional baixo é pressionada, X = " + ballX + " , Y _ "+ballY);
			canvas.remove(ballObj);
			newImage();
		 }
	}
	...
	function left()
	{
		if(ballX >5)
		{
			...
			console.log("Quando a tecla direcional baixo é pressionada, Y = " + ballY + " , X _ "+ballX);
			canvas.remove(ballObj);
			newImage();
		}
	}
